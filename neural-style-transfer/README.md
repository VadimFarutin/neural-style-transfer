...
|:------------------------------------ |:----------------- |:---------------------------------------------------------------------------- |:-------------------------- | 
| `data/`                              | Data              | `storage:neural-style-transfer/data/`                              | `/neural-style-transfer/data/` | 
| `modules/` | Python modules    | `storage:neural-style-transfer/modules/` | `/neural-style-transfer/modules/` |
| `config/`                            | Configuration files | `storage:neural-style-transfer/config/`                          | `/neural-style-transfer/modules/` |
| `notebooks/`                         | Jupyter notebooks | `storage:neural-style-transfer/notebooks/`                         | `/neural-style-transfer/notebooks/` |
| No directory                         | Logs and results  | `storage:neural-style-transfer/results/`                           | `/neural-style-transfer/results/` |
...
into `storage:neural-style-transfer/data` mounted to your development environment's `/project/data`.
